...
pub fn render_popup(frame: &mut Frame, app: &App, popup: &PopupState) {
    ...
    match popup {
        PopupState::WordDetail {
            ...
            clear_area(frame, padded_rect(area, frame.size()), t.bg, t.fg);
...
/// Clear an area and fill it with the theme background and foreground colors.
fn clear_area(frame: &mut Frame, area: Rect, bg: Color, fg: Color) {
